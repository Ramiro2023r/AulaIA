 ...
 *
 * <p>
 * Rutas públicas: documentación (OpenAPI/Swagger), salud de Actuator y
...
public class SecurityConfig {
        ...
        public CorsConfigurationSource corsConfigurationSource() {
                ...
                configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "http://localhost:*")); // Angular
                                                                                                                // local
                                                                                                                // dev
